...
### [Automotive Diagnostic Security Analyzer](https://github.com/LRTechpro/Automotive-Diagnostic-Security-Analyzer)

Clean-room Python analyzer for synthetic UDS traces, diagnostic-session and SecurityAccess state tracking, negative-path validation, programming-sequence checks, and evidence export to Markdown, JSON, and CSV.
...
Python and SocketCAN laboratory project demonstrating UDS Diagnostic Session Control and Security Access through a deliberately weak seed-key implementation on a controlled virtual CAN network.
